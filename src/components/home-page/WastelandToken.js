export default function WastelandToken() {
    return (
        <section>
            <div className="relative w-full min-h-[90vh] flex justify-center items-center py-10 px-4 bg-[url('/assets/images/17_upscayl_4x.png')] bg-cover bg-center bg-no-repeat">
